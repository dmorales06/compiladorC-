      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6">
          <h1 className="text-3xl font-bold flex items-center gap-2">
            ...
            Compilador C++ con Detección Estricta de Errores
          </h1>
          <p className="text-blue-100 mt-2">
            Análisis Léxico • Sintáctico con Validación Estricta • Semántico • Generación de Código
          </p>
          <p className="text-blue-200 text-sm mt-1">
            ⚠️ Detecta errores sintácticos: paréntesis faltantes, punto y coma, llaves, estructuras malformadas
          </p>
        </div>
...
int main() {
    ...
    return 0;
            ...
            <div className="mt-2 text-sm text-gray-600 space-y-1">
              <p>💡 <strong>Errores detectados:</strong> paréntesis faltantes, punto y coma, llaves no balanceadas, estructuras de control malformadas</p>
              <p>🔧 <strong>Estructuras soportadas:</strong> funciones, clases, if/else, while, for, do-while, switch, variables, arrays</p>
            </div>
          </div>
          ...
          <div className="border-b border-gray-200 mb-6">
            <nav className="flex space-x-8">
              {[
                ...
                { id: 'sintactico', label: 'Análisis Sintáctico', icon: AlertCircle, desc: 'Detección de Errores' },
                { id: 'semantico', label: 'Análisis Semántico', icon: Info, desc: 'Validación Semántica' },
